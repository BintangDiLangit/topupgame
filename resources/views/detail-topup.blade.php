...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href={{ asset('css/homepage.css') }}> <!-- Get navbar & footer style -->
                ...
                <div class="col-xl-3 col-lg-4 col-md-5 pb-30 pb-md-0 pe-md-25 text-md-start">
                    <div class="row align-items-center">
                        <div class="col-md-12 col-4">
                            <img src={{ asset('assets/img/Thumbnail-3.jpg') }} width="280" height="380" class="img-fluid" alt="">
                        </div>
                        <!-- Mobile: Game title -->
