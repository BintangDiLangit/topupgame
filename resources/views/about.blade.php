                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-5 position-relative d-none d-lg-block">
                        <div class="breadcrumb__img">
                            <img src="{{ asset('assets/img/others/breadcrumb_img01.png') }}" alt="img">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-8">
                    <div class="about__three-images">
                        <img src="{{ asset('assets/img/others/mask_img01.jpg') }}" alt="img" class="left">
                        <img src="{{ asset('assets/img/others/mask_img02.jpg') }}" alt="img" class="right">
