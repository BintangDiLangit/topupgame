        ...
        <section class="sidebar">
            <div class="content pt-50 pb-30 ps-30">
                <div class="user text-center pb-50 pe-30">
                    <img src="{{ asset('assets/img/avatar-1.png') }}" width="90" height="90" class="img-fluid mb-20" />
                ...
                <div class="menus">
                    <div class="item mb-30">
                        ...
                        <p class="item-title m-0">
                            <a href="{{ asset('member/overview.html') }}" class="text-lg text-decoration-none">Overview</a>
                        </p>
                    </div>
                    <div class="item mb-30">
                        <svg class="icon me-3" width="25" height="25" viewBox="0 0 25 25" fill="none"
                        ...
                        <p class="item-title m-0">
                            <a href="{{ asset('member/transactions.html') }}" class="text-lg text-decoration-none">Transactions</a>
                        </p>
                    </div>
                    <div class="item mb-30">
                        <svg class="icon me-3" width="25" height="25" viewBox="0 0 25 25" fill="none"
                    ...
                    <div class="item active mb-30">
                        ...
                        <p class="item-title m-0">
                            <a href="" class="text-lg text-decoration-none">Settings</a>
                        </p>
                    </div>
                    <div class="item mb-30">
                        <svg class="icon me-3" width="25" height="25" viewBox="0 0 25 25" fill="none"
                    ...
                    <form action="">
                        <div class="photo d-flex">
                            <div class="position-relative me-20">
                                <img src="{{ asset('assets/img/avatar-1.png') }}" width="90" height="90" class="avatar img-fluid" />
                                <div
                        ...
                        <div class="pt-30">
                            <label for="name" class="form-label text-lg fw-medium color-palette-1 mb-10">Full
                                Name</label>
                        ...
                        <div class="pt-30">
                            ...
                            <input type="tel" class="form-control rounded-pill text-lg" id="phone" name="phone"
                                aria-describedby="phone" placeholder="Enter your phone number">
                        </div>
                        <div class="button-group d-flex flex-column pt-50">
                            <button type="submit" class="btn btn-save fw-medium text-lg text-white rounded-pill"
