                        ...
                        <form action="{{ route('admin.master.kategori.store') }}" method="post"
                            ...
                            <div class="modal-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="nama_master_kategori" class="form-control input-rounded"
                                        placeholder="nama master kategori">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file" name="image_master_kategori" class="form-control" required
                    ...
                    <tbody>
                        @foreach ($masterKategoris as $item)
                            <tr>
                                ...
                                <td>
                                    {{ $item->nama_master_kategori }}
                                </td>
                                <td>
                                    {{ $item->slug_master_kategori }}
                                </td>
                                <td>
                                    {{ $item->desc }}
                                </td>
                                <td>
                                    <img src="{{ $item->image_master_kategori }}" width="50px" alt="">
                                </td>
                                <td>
                                    {{ $item->status }}
                                </td>
                                    ...
                                    <div class="d-flex action-button">
                                        ...
                                        <div class="modal fade" id="exampleModalCenter{{ $item->id }}"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">Update Master Kategori</h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal">
                                                        </button>
                                                    </div>
                                                    <form
                                                        action="{{ route('admin.master.kategori.update', ['id' => $item->id]) }}"
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" name="nama_master_kategori"
                                                                    class="form-control"
                                                                    placeholder="nama master kategori"
                                                                    value="{{ $item->nama_master_kategori }}" required>
                                                            </div>
                                                            <div class="mb-3">
                                                                <label class="form-label">Deskripsi :</label>
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="file" name="image_master_kategori"
                                        ...
                                        <div class="modal fade" id="deleteModal{{ $item->id }}"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">Hapus Master Kategori</h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal">
                                                        </button>
                                                    </div>
                                                    <form
                                                        action="{{ route('admin.master.kategori.destroy', ['id' => $item->id]) }}"
                                                        method="post" enctype="multipart/form-data">
                                                        @csrf
                                                        @method('DELETE')
                                                        <div class="modal-body">
