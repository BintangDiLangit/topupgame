...
<!-- Mirrored from zenix.dexignzone.com/laravel/demo/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Mar 2023 09:34:08 GMT -->
...
<head>
    ...
    <meta name="csrf-token" content="6H7foFcinyquRZA9ftu2tNHVCgZ1fKS6RJ3a3s4u">
					...
					<div class="card">
						...
						<div class="card-body p-3 pb-0 sell-order">
							<select class="form-control custom-image-select-2 image-select mt-3 mt-sm-0">
								<option data-thumbnail="public/images/svg/lit3.svg">Litecoin</option>
								<option data-thumbnail="public/images/svg/btc.svg">Ripple</option>
								<option data-thumbnail="public/images/svg/eth.svg">Ethereum</option>
								<option data-thumbnail="public/images/svg/btc.svg">Bitcoin</option>
							</select>
				...
				<div class="col-sm-6">
					<div class="card">
						...
						<div class="card-body p-3 pb-0">
							<select class="form-control custom-image-select-2 image-select mt-3 mt-sm-0">
								<option data-thumbnail="public/images/svg/monero.svg">Monero</option>
								<option data-thumbnail="public/images/svg/eth.svg">Ethereum</option>
								<option data-thumbnail="public/images/svg/btc.svg">Bitcoin</option>
								<option data-thumbnail="public/images/svg/ltc.svg">Litecoin</option>
							</select>
							<div class="table-responsive">
					...
					<div class="card">
						<div class="card-header d-sm-flex d-block pb-0 border-0">
							...
							<select class="form-control custom-image-select image-select mt-3 mt-sm-0">
								<option data-thumbnail="public/images/svg/ltc.svg">Yearly (2021)</option>
								<option data-thumbnail="public/images/svg/eth.svg">Weekly (2021)</option>
								<option data-thumbnail="public/images/svg/btc.svg">Daily (2021)</option>
							</select>
						</div>
						<div class="card-body">
			...
			<div class="row">
				<div class="col-sm-6">
					<div class="card-bx stacked card">
						<img src="public/images/card/card1.jpg" alt="">
						<div class="card-info">
				...
				<div class="col-sm-6">
					<div class="card-bx stacked card">
						<img src="public/images/card/card2.jpg" alt="">
						<div class="card-info">
				...
				<div class="col-sm-6">
					<div class="card-bx stacked card">
						<img src="public/images/card/card3.jpg" alt="">
						<div class="card-info">
							<p class="mb-1 text-white fs-14">Main Balance</p>
							<div class="d-flex justify-content-between">
								<h2 class="num-text text-white mb-5 font-w600">$673,412.66</h2>
				...
				<div class="col-sm-6">
					<div class="card-bx stacked card">
						<img src="public/images/card/card4.jpg" alt="">
						<div class="card-info">
							<p class="mb-1 text-white fs-14">Main Balance</p>
							<div class="d-flex justify-content-between">
								<h2 class="num-text text-white mb-5 font-w600">$673,412.66</h2>
							...
							<div class="testimonial-one px-4 owl-right-nav owl-carousel owl-loaded owl-drag">
								<div class="items">
									<div class="text-center">
										<img class="mb-3 rounded" src="public/images/contacts/Untitled-1.jpg" alt="">
								...
								<div class="items">
									<div class="text-center">
										<img class="mb-3 rounded" src="public/images/contacts/Untitled-2.jpg" alt="">
								...
								<div class="items">
									<div class="text-center">
										<img class="mb-3 rounded" src="public/images/contacts/Untitled-3.jpg" alt="">
								...
								<div class="items">
									<div class="text-center">
										<img class="mb-3 rounded" src="public/images/contacts/Untitled-4.jpg" alt="">
								...
								<div class="items">
									<div class="text-center">
										<img class="mb-3 rounded" src="public/images/contacts/Untitled-5.jpg" alt="">
