...
<script src="{{ asset('public/vendor/owl-carousel/owl.carousel.js') }}" type="text/javascript"></script>
...
{{-- <script src="{{ asset('public/js/styleSwitcher.j') }}s" type="text/javascript"></script> --}}
