    ...
    <div class="card">
        <div class="card-header d-sm-flex d-block">
            <div class="me-auto mb-sm-0 mb-3">
                <h4 class="card-title mb-2">List Role</h4>
            </div>
                        ...
                        <form action="{{ route('admin.roles.store') }}" method="post"
                            ...
                            <div class="modal-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="nama_role" class="form-control input-rounded"
                                        ...
                                        <div class="modal fade" id="exampleModalCenter{{ $item->id }}"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form
                                                        action="{{ route('admin.roles.update', ['role' => $item->id]) }}"
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" name="nama_role" class="form-control input-rounded"
                                                                    placeholder="nama role" value="{{ $item->nama_role }}">
                                                            </div>
                                                        </div>
                                                        <div class="modal-footer">
