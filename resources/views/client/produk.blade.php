        ...
        <div class="row">
            ...
            <div class="shop__details-content">
                ...
                <div class="shop__details-price">
                    <span class="amount">{{ 'Start From Rp ' .
                        number_format($produks[0]->harga_jual, 0, ',', '.')
                ...
                <form class="offCanvas__newsletter" id="payment_form"
                    ...
                    <div class="shop__details-qty">
                        <div class="cart-plus-minus d-flex flex-wrap align-items-center">
                            ...
                            <button class="shop__details-cart-btn" type="button" class="btn btn-primary"
                            ...
                            <div class="modal fade" id="checkoutModal" tabindex="-1"
                                ...
                                <div class="modal-dialog bg-dark">
                                    <div class="modal-content bg-dark">
                                        ...
                                        <form action="{{ route('place.order', ['game_name' => 'mobile-legend', 'slug' => 'diamonds']) }}" method="post">
                                            @csrf
                                            <div class="modal-body">
                                                <div class="px-2">
                                                    <ul class="list-unstyled">
                                                        <li class="">John Doe</li>
                                                        <li class="">
                                                            thoriq@gmail.com
                                                        </li>
                                                        <li class="mt-1">
...
<script>
    $(document).ready(function () {
        ...
        $("#game_code").on("change", function (e) {
            ...
            //         "Silahkan Masukkan ID Akun dan ID Zone kamu"
            //     );
            ...
            //     var h5Element = $("#nicknameShow h5");
                ...
                // if (
                //     h5Element.text().trim().length === 0 ||
                //     $("#nicknameShow h5").hasClass("text-danger")
                // ) {
                    // loading
                    // $("#submit-btn")
                    //     .html(
